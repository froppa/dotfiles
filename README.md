...
- Raycast Script Commands live in `home/dot_config/raycast/` (deployed to `~/.config/raycast/`). On a new machine, add that folder once via Raycast → Settings → Extensions → Script Commands → Add Script Directory.
